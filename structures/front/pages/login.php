      ...
      <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
          <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
            <img src="/assets/images/logofinal.svg">
          </div>
        </div>
        <!-- /Left Text -->
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" action="/login-action" method="POST">
              ...
              <div class="mb-3 form-password-toggle">
                <div class="d-flex justify-content-between">
                  ...
                  <a href="auth-forgot-password-cover.html">
                    <small style="color:#d66826ff;">Mot de passe oublié ?</small>
                  </a>
                </div>
              ...
              <button class="btn btn-primary btnLogin d-grid w-100">s'identifier</button>
            </form>

            <p class="text-center">
              <span>Nouveau sur notre plateforme ?</span>
              <a href="auth-register-cover.html">
                <span style="color:#d66826ff;">Créer un compte</span>
              </a>
            </p>
